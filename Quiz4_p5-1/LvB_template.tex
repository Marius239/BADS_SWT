...
\title[Short Title - please modify the figure in the lower right corner:]{Prime Numbers and Prime Factorization}
% Define the authors:
...
\begin{itemize}
	...
	\item Use \verb(\ln( or \verb(\log( to write the symbols for natural logarithm or decimal logarithm, it produces
\[ 1 = \ln (\exp(1)), \quad 1 = \log(10) \]
