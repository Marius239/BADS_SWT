#### DATA PREPARATION BADS - FEATURE SELECTION ######
...
d <- read.csv("C:/Users/User/Desktop/Master/5th_Semester/Business_Analytics/SWT/BADS - SWT - Trainingset - 2015-10-27/BADS - SWT - Trainingset - 2015-10-27.csv", stringsAsFactors=FALSE)

vars <- read.csv("C:/Users/User/Documents/GitHub/BADS_SWT/Missing_Values/Variables_V2.csv", sep=";", stringsAsFactors=FALSE)
...
numericalVariablesToSelect <- na.omit(numericalVariablesToSelect) # eliminate NAs (there were two)
